...
//Load header and save in variable
        ...
        $this->load->model('combinations');
    }

    public
            function index()
    {
        $this->data['mappings'] = $this->combinations->get_mapping();
//       echo "<pre>";     print_r($this->data['mappings'] );die;
        $this->data['total'] = count($this->data['mappings']);
        $this->load->view('combination/index', $this->data);
    }
