...
//Load header and save in variable
    ...
    {
        $this->data['users'] = $this->common->get_user_data();
    ...
    public function view($user_id = NULL)
    {
        ...
        {
            $this->data['users'] = $this->common->select_database_id('user', 'user_id', (int) $user_id, '*');
...
//                    $this->email->send();
    ...
    public function email_exist($user_id = NULL)
    {
//        print_r($this->input->post(NULL,TRUE));die();
