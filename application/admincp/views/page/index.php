...
<div class="content-wrapper">
    <section class="content-header">
        <h2>
            Manage <?php echo ucfirst(ucfirst('Page')); ?>
           <?php echo (($this->uri->segment(2))? ucfirst('Page'): ' ('.$total.')') ; ?>
        </h2>
                                    ...
                                    <tbody>
                                        <?php for ($i = 0; $i < count($page); $i++) { ?>
                                            <tr <?php if (($i + 1) % 2 == 0) { ?>class='alternate-row'<?php } ?>>
                                                <td><?php echo stripslashes($page[$i]['title']); ?></td>
                                                <!--<td><?php // echo stripslashes($page[$i]['subject']); ?></td>-->
                                                <td class="center"> 
                                                    <!--<a class="btn" href="<?php echo site_url('page/view/' . $page[$i]['pageid']); ?>"> <i class="fa fa-eye"></i></a>-->
                                                    <a class="btn btn-primary" href="<?php echo site_url('page/edit/' . $page[$i]['pageid']); ?>"> <i class="fa fa fa-pencil-square-o"></i> Edit</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
