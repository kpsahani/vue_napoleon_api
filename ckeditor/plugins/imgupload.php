...
$upload_dir = '/crowdfunding/ck_upload/';
...
//  echo $uploadpath = $_SERVER['DOCUMENT_ROOT'] .'/'. $upload_dir . $img_name;exit;       // full file path
  ...
  if($_FILES['upload']['size'] > $imgsets['maxsize']*5000) $err .= '\\n Maximum file size must be: '. $imgsets['maxsize']. ' KB.';
